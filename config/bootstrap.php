...
// Read predefined constants
use Cake\I18n\I18n;

$identKinds = [];
$identKindsFile = dirname(__FILE__) . DS . I18n::getLocale() . DS . 'ident_kinds.php';
if (file_exists($identKindsFile)) {
    include $identKindsFile;
}

$touristTaxKinds = [];
$touristTaxKindsFile = dirname(__FILE__) . DS . I18n::getLocale() . DS . 'touristTax_kinds.php';
if (file_exists($touristTaxKindsFile)) {
    include $touristTaxKindsFile;
}

$monthlyStatuses = [];
$monthlyStatusesFile = dirname(__FILE__) . DS . I18n::getLocale() . DS . 'monthly_statuses.php';
if (file_exists($monthlyStatusesFile)) {
    include $monthlyStatusesFile;
}

Configure::write([
    'identKinds' => $identKinds,
    'touristTaxKinds' => $touristTaxKinds,
